...
public class ITDS121LabRecursion {
	...
	public static int sumNatural(int n) {
		// =========== YOUR CODE HERE =============//
		// Hint: What is the smallest n that can be return without computation (base
		// case)?
		// Hint: Assuming that sumNatural(n-1) has been computed, how would you combine
		// n with sumNatural(n-1) before returning (recursive case))?
		if (n == 1) {
			return 1;
		}
	...
	// =========== YOUR CODE HERE (**You may need this helper method. If not, then
	// ignore it.**) =============//
	public static boolean isPalindromeHelper(char[] d, int start, int end) {
		// Hint: What are the values of start and end, that you can answer directly if
		// d[start] ... d[end] is a palindrome (base case 1)?
		// Hint: What are the values of d[start] and d[end] that you can answer directly
		// that d[start] ... d[end] is NOT a palindrome (base case 2)?
		// Hint: How would you call to this method again with a smaller problem
		// (recurive case)?
		return false;
	}
	// =======================================//
	...
	public static void printReverse(Queue<String> q) {
		// =========== YOUR CODE HERE =============//
		// Hint: What is the size of q that do can simply return without printing
		// anything (base case)?
		// Hint: You might want to hold on to the first element, while leaving the rest
		// of q for the recurisve call to deal with.
		// Hint: Then after the recurive call has return, it's now your turn to print
		// the element you held.
		if (q.isEmpty()) {
			return;
		}
