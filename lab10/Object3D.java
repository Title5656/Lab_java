...
public abstract class Object3D {
	...
	public static enum Material {
		Water, Rubber, Gold, OakWood, Butter, Wax, Soap, Air, Oxygen, Hydrogen, Helium
	}; // All the material types

	public static final double[] DENSITIES = { 1000, 1522, 19320, 760, 911, 961, 801, 1.225, 1.43, 0.08988, 0.1664 }; // Corresponding
																														// densities
	...
	public double getMass() {
		// ****************** YOUR CODE HERE *************************//
		return this.getVolume() * DENSITIES[matType.ordinal()];
		// ***********************************************************//
	}
	...
	public boolean canFloat() {
		// ****************** YOUR CODE HERE *************************//
		if (DENSITIES[matType.ordinal()] < 1000) {
			return true;
		} else {
			return false;
		}
	...
	public boolean canFly() {
		// ****************** YOUR CODE HERE *************************//
		if (DENSITIES[matType.ordinal()] < 1.225) {
			return true;
		} else {
			return false;
		}
