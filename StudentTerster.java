...
public class StudentTerster {
	...
	// System.out.println();
	// System.out.println("Converting WaxDie B to a Sphere with radius:
	// "+String.format("%,.2f", s.getRadius())+" and volume:
	// "+String.format("%,.2f", s.getVolume()));
	// System.out.println("Converting ButterBall Z to a Cube with edge length:
	// "+String.format("%,.2f", c.getEdge())+" and volume: "+String.format("%,.2f",
	// c.getVolume()));
	// }
